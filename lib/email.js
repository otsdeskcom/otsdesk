/**
 * OTS Desk — Transactional email via Resend
 * ---------------------------------------------------------------------------
 * Sends OTP and billing emails from no-reply@otsdesk.com using Resend.
 * In development (no RESEND_API_KEY) it logs the email to console instead.
 * ---------------------------------------------------------------------------
 */
